...
for image_dir in subdirs:
    ...
    output_path = os.path.join(directory + "_resized", image_dir)
...
prompt_path = os.path.join(directory + "_resized", "prompt.json")
os.copy(prompt_path, os.path.join(directory + "_resized", "prompt.json"))
